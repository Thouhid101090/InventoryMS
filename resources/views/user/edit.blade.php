            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img class="img-account-profile rounded-circle mb-2" src="{{ asset('public/uploads/users/'.$user->image)}}" alt="" id="image-preview" />
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('userName_en') is-invalid @enderror" id="name" name="userName_en" type="text" placeholder=""
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('contactNumber_en') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            <label class="small mb-1" for="contactNumber_bn">Contact(Bangla) <span class="text-danger">*</span></label>
                            <input class="form-control form-control-solid @error('contactNumber_bn') is-invalid @enderror"
                            id="contactNumber_bn" name="contactNumber_bn" type="text"
                             placeholder="" value="{{ old('contactNumber_bn'),$user->contact_no_bn }}" />
